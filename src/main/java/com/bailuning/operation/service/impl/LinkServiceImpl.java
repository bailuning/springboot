...
import com.bailuning.operation.code.common.MD5Util;
import com.bailuning.operation.entity.Link;
import com.bailuning.operation.mapper.LinkMapper;
...
public class LinkServiceImpl implements LinkService {
    ...
    public String save(Link link) {
        String shortUrl = "http://192.168.3.122/";
    ...
    public static void main(String[] args) {
        ...
        String sLongUrl = "http://test.inglemirepharmmall.com/?inviteCode=wpyatg&shareUserId=1283&share=h5#/upgradeMember?fromPage=share" ; //长链接
        LinkServiceImpl link = new LinkServiceImpl();
        String result = link.gererateShortUrl(sLongUrl);
        // 打印出结果
        System.out.println("短链接为： "+ "http://192.168.3.122"+result);
